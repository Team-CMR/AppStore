...
//   }
  ...
  const onButtonClicked = () => {
    ...
    //   type: "message",
    //   msg: document.getElementById("inpMessageUser").value,
    //   user: state.Username
    // }))
          ...
          <Container maxWidth="sm">
            <div id='contentChat'>
              ...
              {/* <input type="text" id="nuevo-mensaje" onKeyUp={enviarNuevoMensaje(event)}/> */}
                ...
                <hr/>
                <input type="text" placeholder='Message' size="large" id="inpMessageUser" />
            ...
            <div id='contentInitChat'>
              <input type="text" placeholder='Enter username' size="large" onChange={setLoginData} id="inpUsernameChat" />

              <Button variant="contained" type="submit" onClick={setInitChat}>Join chat</Button>
              {/* <Search
